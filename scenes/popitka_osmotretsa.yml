...
- text: Ползти налево, к груде обломков
  next: spassya_v_oblomkah

- text: Ползти прямо, к джунглям
  next: zagrizly_dikie_zveri

- text: Так и ни на что и не решившись, снова потерять сознание от потери сил
  next: smilo_shtormom_v_okean